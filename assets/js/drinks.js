...
fetch(`${BASE_API_URL}/v2/beers/4`)
  ...
  .then((drink1) => {
    drink1.forEach((drink1) => {
      title.appendChild(
        document.createTextNode(`${drink1.name}`),
        subtitle.appendChild(
          document.createTextNode(`${drink1.tagline}`),
          age.appendChild(
            document.createTextNode(`Fabricada desde: ${drink1.first_brewed}`),
            img.setAttribute("src", `${drink1.image_url}`),
            description.appendChild(
              document.createTextNode(`${drink1.description}`),
              beerSize.appendChild(
                document.createTextNode(`${drink1.volume.value} litros`),
                alcohol.appendChild(
                  document.createTextNode(
                    `Alcohol en volumen: ${drink1.abv} %`
                  ),
...
fetch(`${BASE_API_URL}/v2/beers/12`)
  ...
  .then((drink2) => {
    drink2.forEach((drink2) => {
      title2.appendChild(
        document.createTextNode(`${drink2.name}`),
        subtitle2.appendChild(
          document.createTextNode(`${drink2.tagline}`),
          age2.appendChild(
            document.createTextNode(`Fabricada desde: ${drink2.first_brewed}`),
            img2.setAttribute("src", `${drink2.image_url}`),
            description2.appendChild(
              document.createTextNode(`${drink2.description}`),
              beerSize2.appendChild(
                document.createTextNode(`${drink2.volume.value} litros`),
                alcohol2.appendChild(
                  document.createTextNode(
                    `Alcohol en volumen: ${drink2.abv} %`
                  ),
...
fetch(`${BASE_API_URL}/v2/beers/22`)
  ...
  .then((drink3) => {
    drink3.forEach((drink3) => {
      title3.appendChild(
        document.createTextNode(`${drink3.name}`),
        subtitle3.appendChild(
          document.createTextNode(`${drink3.tagline}`),
          age3.appendChild(
            document.createTextNode(`Fabricada desde: ${drink3.first_brewed}`),
            img3.setAttribute("src", `${drink3.image_url}`),
            description3.appendChild(
              document.createTextNode(`${drink3.description}`),
              beerSize3.appendChild(
                document.createTextNode(`${drink3.volume.value} litros`),
                alcohol3.appendChild(
                  document.createTextNode(
                    `Alcohol en volumen: ${drink3.abv} %`
                  ),
